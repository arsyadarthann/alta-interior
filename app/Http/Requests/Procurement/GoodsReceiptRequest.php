...
class GoodsReceiptRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'miscellaneous_cost_details' => 'nullable|array',
            'miscellaneous_cost_details.*.name' => 'required|string|max:255',
            'miscellaneous_cost_details.*.amount' => 'required|numeric|min:1',
