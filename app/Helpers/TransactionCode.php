...
class TransactionCode
{
    public static function generateTransactionCode($transactionType)
    {
        ...
        $isSourceAbleSpecific = in_array($transactionType, ['Stock Audit', 'Stock Adjustment', 'Sales Order', 'Waybill', 'Sales Invoice', 'Sales Invoice Payment']);
        $isNoSourceAble = in_array($transactionType, ['Stock Transfer', 'Purchase Order', 'Purchase Invoice Payment', 'Expense']);
